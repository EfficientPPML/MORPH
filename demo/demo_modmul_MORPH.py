...
BATCH_SIZE = 8192
my_context = ff_context.DRNSlazyContext(
    {"prime": MODULUS_377_INT, "rns_moduli": RNS_MODULI, "precision_bits": 28, "radix_bits": 32}
)
...
with jax.profiler.trace("./demo_traces/MORPH"):
